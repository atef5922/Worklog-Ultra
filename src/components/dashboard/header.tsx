      ...
      <div className="ml-auto flex min-w-0 max-w-full items-center justify-end gap-2 sm:gap-3 lg:gap-4">
        <div className="hidden items-center gap-2 text-[var(--foreground)] md:flex">
          ...
          <div className="flex items-baseline gap-1.5 font-mono tabular-nums lg:gap-2">
            ...
            <span
              aria-hidden
              className="mx-1 hidden h-7 w-px shrink-0 self-center bg-gradient-to-b from-transparent via-[var(--panel-border)] to-transparent opacity-80 2xl:mx-1.5 2xl:h-8 xl:block"
            />
        ...
        >
          ...
          {visibleUnreadMessages > 0 ? (
            <span className="absolute right-1 top-1 inline-flex min-w-5 items-center justify-center rounded-full bg-[#ef4444] px-1.5 text-[0.625rem] font-semibold text-white">
        ...
        <div className="relative" ref={bellRef}>
          ...
          {bellOpen ? (
            <div className="dashboard-header-popover fixed left-3 right-3 top-[calc(var(--topbar-height)_+_0.5rem)] z-30 max-h-[min(70vh,32rem)] overflow-y-auto rounded-3xl border border-[var(--panel-border)] bg-[var(--panel)] p-3 shadow-[0_18px_40px_rgba(15,23,42,0.14)] sm:absolute sm:left-auto sm:right-0 sm:top-[calc(100%+12px)] sm:max-h-none sm:w-[22.5rem] sm:overflow-visible">
              {notificationDetail ? (
                ...
                <div className="space-y-3">
                  ...
                  {noticeItems.length ? (
                    <div className="space-y-2">
                      <p className="px-1 text-[0.6875rem] font-semibold uppercase tracking-[0.16em] text-[var(--muted-foreground)]">Notices</p>
                  ...
                  {assignmentItems.length ? (
                    <div className="space-y-2">
                      <p className="px-1 text-[0.6875rem] font-semibold uppercase tracking-[0.16em] text-[var(--muted-foreground)]">Assignments</p>
                  ...
                  {requestItems.length ? (
                    <div className="space-y-2">
                      <p className="px-1 text-[0.6875rem] font-semibold uppercase tracking-[0.16em] text-[var(--muted-foreground)]">Requests</p>
        ...
        <div className="relative" ref={menuRef}>
          <button
            ...
            type="button"
          >
            <Avatar className="h-8 w-8 border-0 bg-white/15 shadow-[0_2px_10px_rgba(3,8,18,0.45)] ring-2 ring-white/70 sm:h-9 sm:w-9">
          ...
          {menuOpen ? (
            <div className="dashboard-header-popover absolute right-0 top-[calc(100%+10px)] z-20 min-w-[11.25rem] rounded-2xl border border-[var(--panel-border)] bg-[var(--panel)] p-2 shadow-[0_18px_40px_rgba(15,23,42,0.12)]">
              <Link
